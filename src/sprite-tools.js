...
export function opaqueBounds(canvas, alphaThreshold = 8) {
...
export function trimTransparent(canvas, padding = 0, alphaThreshold = 8) {
...
function alphaCenterOfMass(canvas, alphaThreshold = 8) {
  const ctx = get2d(canvas);
...
function anchorPoint(canvas, mode) {
...
export function alignCanvases(canvases, mode) {
...
function findRuns(values, bridgeGap) {
  const raw = [];
  let start = -1;
...
export function suggestTransparentGrid(source, width, height, alphaThreshold = 8) {
